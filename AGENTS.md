...
- Source: `custom_components/ha_hoymiles_cloud/`
...
- Run locally (recommended): copy `custom_components/ha_hoymiles_cloud` into your Home Assistant config’s `custom_components/` and restart Home Assistant.
